      ...
      <main className="max-w-7xl mx-auto px-6 py-8 space-y-8">
        ...
        <section className="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
          ...
          <p className="text-gray-700 leading-relaxed">
            The benchmark compares six FHIR server implementations under identical workload, hardware, and database
        ...
        <section className="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div className="border border-gray-200 rounded-md p-4">
              <h3 className="font-semibold text-gray-900">InterSystems IRIS for Health</h3>
              <p className="text-sm text-gray-600 mt-1">intersystemsdc/irishealth-community</p>
              <p className="text-sm text-gray-700 mt-2">Community Edition, basic auth (can't be disabled), 16 vCPU / 54 GB RAM — app and embedded database in one container (app + datastore budget)</p>
            </div>
          </div>
        </section>
